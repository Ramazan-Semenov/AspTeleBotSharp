...
namespace AspTeleBotSharp.Models.Commandbot
{
    public class ComBot
    {

        public bool ff = false;
        private readonly ObservableCollection<Questions> command_1;
        ...
        public void ex(CallbackQueryEventArgs e)
        {
            ...
            BotUser person = new BotUser(e.CallbackQuery.Message.Chat.FirstName, e.CallbackQuery.Message.Chat.Id);
            ...
            BotUser person1 = new BotUser(e.CallbackQuery.Message.Chat.FirstName, e.CallbackQuery.Message.Chat.Id, command_1);
